...
# todos os discos e pede a digitação de uma senha para a liberação da máquina.
# E é claro que os criminosos exigem um pagamento para informar a senha.

#Ao analisar o código do programa deles, porém, você descobre que a senha é composta pela palavra “LIBERDADE”
...
minuntos = int(input("Digite os minutos atuais: "))
